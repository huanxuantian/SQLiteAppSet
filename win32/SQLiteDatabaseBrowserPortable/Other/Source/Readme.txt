...
user in an INI file next to SQLiteDatabaseBrowserPortable.exe called SQLiteDatabaseBrowserPortable.ini.
...
copy AppNamePortable.ini from this directory to SQLiteDatabaseBrowserPortable.ini next to
SQLiteDatabaseBrowserPortable.exe. The options in the INI file are as follows:
